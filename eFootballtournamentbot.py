...
async def send_qr_code(update: Update, context: CallbackContext):
    try:
        # Read the image file as bytes and send it
        with open(r"C:\telegram bot\gpay_qr.png", "rb") as photo_file:
            await context.bot.send_photo(
                chat_id=update.effective_user.id,  # Send privately to the user
                photo=photo_file,
